...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 w-full z-[60] flex items-center justify-between px-6 h-16 bg-surface/80 backdrop-blur-2xl transition-colors">
        {/* Menu Icon */}
        <button 
          onClick={() => setIsMenuOpen(!isMenuOpen)}
          className="p-2 text-on-surface hover:text-primary transition-colors focus:outline-none relative z-[60]"
        >
        ...
        {/* Brand ID */}
        <Link to="/" onClick={handleClose} className="text-xl font-bold tracking-[0.2em] text-on-surface uppercase relative z-[60]">
